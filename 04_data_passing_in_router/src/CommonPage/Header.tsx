 ...
 * if we write end then the className with active  is generated which we can target in css  on clicking the link and change its style
 * ********************************************************
 * 
        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <NavLink end to="/aboutPath">
                  About
                </NavLink>
              </li>
              <li>
                <NavLink end to="/contactPath">
                  Contact
                </NavLink>
              </li>
              <li>
